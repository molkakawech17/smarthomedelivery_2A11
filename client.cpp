...
client::client(QString prenom,QString nom,int cin,int abonne_carte,QString email)
{
    this->email=email;
    this->nom=nom;
    this->prenom=prenom;
...
bool client::ajouterclient()
{
    ...
    QString abo_string= QString::number(abonne_carte);
    query.prepare("INSERT INTO client( PRENOM, NOM, CIN, ABONNE_CARTE, EMAIL)"
                  "VALUES (:prenom, :nom, :cin, :abonne_carte, :email)");

    query.bindValue(":prenom",prenom);
    query.bindValue(":nom",nom);
    query.bindValue(":cin",cin_string);
    query.bindValue(":abonne_carte",abo_string);
